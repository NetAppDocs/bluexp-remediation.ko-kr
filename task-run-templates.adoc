...
[role="lead"]
조직에서 특정 워크로드 및 애플리케이션에 최적화된 작업 환경 또는 볼륨을 생성하기 위해 구축한 애플리케이션 템플릿 중 하나를 선택합니다. 템플릿을 사용하여 를 활성화할 수도 있습니다 https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-ontap-backup-to-cloud.html["BlueXP 백업 및 복구"^], https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["BlueXP 분류"^], 및 https://docs.netapp.com/us-en/cloud-manager-replication/concept-replication.html["BlueXP 복제"^] 생성된 볼륨 또는 기존 볼륨에 대해 선택합니다.
...
[role="quick-margin-list"]
* 템플릿이 같은 볼륨에 클라우드 서비스를 활성화하는 경우 https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-ontap-backup-to-cloud.html["BlueXP 백업 및 복구"^] 또는 https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["BlueXP 분류"^]에서 서비스가 활성화되어 있고 사용 중인 환경에서 라이센스가 부여되었는지 확인합니다.
...
* 템플릿이 같은 볼륨에 클라우드 서비스를 활성화하는 경우  https://docs.netapp.com/us-en/cloud-manager-backup-restore/concept-ontap-backup-to-cloud.html["BlueXP 백업 및 복구"^], https://docs.netapp.com/us-en/cloud-manager-data-sense/concept-cloud-compliance.html["BlueXP 분류"^], 또는 https://docs.netapp.com/us-en/cloud-manager-replication/concept-replication.html["BlueXP 복제"^]에서 서비스가 활성화되어 있고 사용 중인 환경에서 라이센스가 부여되었는지 확인합니다.
...
* https://docs.netapp.com/us-en/cloud-manager-ontap-onprem/task-manage-ontap-connector.html#create-volumes-from-templates["사내 ONTAP 볼륨을 프로비저닝하는 방법"^]
