...
을 참조하십시오 https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-create-volumes.html#create-volumes["Azure NetApp Files 볼륨 프로비저닝 방법"^] ANF 볼륨 템플릿에서 완료해야 하는 모든 매개변수에 대한 자세한 내용은
